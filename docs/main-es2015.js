...
let AddphotosComponent = class AddphotosComponent {
    constructor(svc) {
        this.svc = svc;
...
AddphotosComponent.ctorParameters = () => [
...
let AddtodosComponent = class AddtodosComponent {
    constructor(svc, tsvc) {
        this.svc = svc;
        this.tsvc = tsvc;
...
AddtodosComponent.ctorParameters = () => [
...
let PohtosComponent = class PohtosComponent {
    constructor(svc, rot) {
        this.svc = svc;
        this.rot = rot;
        this.title = "";
...
PohtosComponent.ctorParameters = () => [
...
let Pipe1Pipe = class Pipe1Pipe {
    transform(arr, title, body, id, userid) {
...
let PipenumberPipe = class PipenumberPipe {
    transform(arr, serc, value) {
        if (serc) {
...
let PipestrPipe = class PipestrPipe {
    transform(arr, serc, value) {
...
let PipetodoPipe = class PipetodoPipe {
    transform(arr, title, userid, id) {
...
let PhotosService = class PhotosService extends _basic_service__WEBPACK_IMPORTED_MODULE_2__["BasicService"] {
    constructor(http) {
        super(http, "photos");
        this.http = http;
        this.tenlastphos = [];
...
let PostService = class PostService extends _basic_service__WEBPACK_IMPORTED_MODULE_2__["BasicService"] {
    constructor(http) {
        super(http, 'posts');
        this.tenlastpos = [];
    }
...
let TodoService = class TodoService extends _basic_service__WEBPACK_IMPORTED_MODULE_3__["BasicService"] {
    // todos:Todos[]
    constructor(http) {
        super(http, 'todos');
        this.http = http;
...
let UserService = class UserService extends _basic_service__WEBPACK_IMPORTED_MODULE_3__["BasicService"] {
    constructor(http) {
        super(http, 'users');
        this.http = http;
    }
